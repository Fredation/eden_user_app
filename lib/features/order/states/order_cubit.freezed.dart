...
class _$OrderStateImpl implements _OrderState {
  const _$OrderStateImpl({this.isLoading = false, this.error, this.data});
  ...
  @override
  String toString() {
    return 'OrderState(isLoading: $isLoading, error: $error, data: $data)';
  }
...
abstract class _OrderState implements OrderState {
  const factory _OrderState(
      {final dynamic isLoading,
      final Failure? error,
      final dynamic data}) = _$OrderStateImpl;
